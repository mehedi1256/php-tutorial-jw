            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/dynamic-web-application/notes"
                           class="<?php echo urlIs("/dynamic-web-application/notes") ? "bg-gray-900 text-white" : "text-gray-300"; ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Notes</a>
